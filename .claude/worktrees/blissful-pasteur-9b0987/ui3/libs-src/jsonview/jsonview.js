...
(function (jQuery)
{
	...
	JSON_VALUE_TYPES = ['object', 'array', 'number', 'string', 'boolean', 'date', 'null'];
	JSONFormatter = (function ()
	{
		...
		JSONFormatter.prototype.valueToHTML = function (value, level)
		{
			...
			var method = this["" + valueType + "ToHTML"];
			return method.call(this, value, level);
		};
		...
		{
			return this.stringToHTML(value);
		};
